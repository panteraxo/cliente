    ...
    <header className="flex flex-col items-center justify-center mb-5 xl:flex-row xl:justify-between">
          ...
          {/* <div>
            <ul className="flex items-center justify-between flex-wrap">
              ...
              <li>
                <button className="mx-2 bg-blue-500 text-white font-bold py-2 px-8 rounded shadow border-2 border-blue-500 hover:bg-transparent hover:text-blue-500 transition-all-duration-300">Download</button>
              </li>
